...
export class createDatabase1677866879061 implements MigrationInterface {
    name = 'createDatabase1677866879061'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules_users_properties" ("id" SERIAL NOT NULL, "hour" character varying NOT NULL, "date" TIMESTAMP NOT NULL, "realEstateId" integer, "userId" integer, CONSTRAINT "PK_751450246dee9abc82a47dabc4c" PRIMARY KEY ("id"))`);
